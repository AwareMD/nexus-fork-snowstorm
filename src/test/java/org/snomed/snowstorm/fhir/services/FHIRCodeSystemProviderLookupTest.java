...
class FHIRCodeSystemProviderLookupTest extends AbstractFHIRTest {
	...
	private static final String FR_CS_JSON = """
			{ "resourceType": "CodeSystem", "url": "%s", "version": "1", "name": "LookupLanguageTestFr", "status": "draft", "content": "complete", "language": "fr",
			  "concept": [ { "code": "CONSULT", "display": "Consultation", "designation": [ { "language": "en", "value": "Consultation (EN)" } ] } ] }""";
	...
	void testNonSnomedDisplayLanguage() {
		...
		// A French code system's own display is the French display; nothing requested means nothing changes.
